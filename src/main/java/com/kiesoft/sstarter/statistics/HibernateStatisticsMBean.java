package com.kiesoft.sstarter.statistics;
...
public class HibernateStatisticsMBean implements InitializingBean {
    ...
    @Autowired
    public HibernateStatisticsMBean(ServletContext servletContext, Environment env) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        EntityManagerFactory emf = (EntityManagerFactory) wac.getBean("databaseEntityManager");
